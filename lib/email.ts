...
export async function sendNightlyReport(
  ...
  await transporter.sendMail({
    ...
    html: `
      ...
      <body style="margin: 0; padding: 20px; background: #1a1a1a; font-family: 'Metrophobic', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
        <div class="container" style="max-width: 650px; margin: 0 auto; background: #000; border-radius: 20px; overflow: hidden; border: 2px solid #f59e0b;">
          ...
          <div class="header" style="background: linear-gradient(135deg, #f59e0b 0%, #fa8c1d 100%); padding: 32px 28px; text-align: center;">
            <h1 style="color: #000; margin: 0; font-size: 26px; font-weight: 800; letter-spacing: -0.5px; font-family: 'Playfair Display', serif;">Daily Summary | ${dateStr}</h1>
            <p style="color: #1a1a1a; margin: 8px 0 0; font-size: 14px; font-style: italic; font-weight: 500;">Auto Generated by Tickd</p>
          </div>

          <!-- Content -->
          <div class="content" style="padding: 32px 28px; background: #0a0a0a; border-top: 2px solid #f59e0b; border-bottom: 2px solid #f59e0b;">
            
            <!-- Stats -->
            <div class="stats-list" style="background: #1a1a1a; padding: 20px; border-radius: 8px; margin-bottom: 24px; border-left: 4px solid #f59e0b;">
            ...
            <!-- Tasks Section -->
            <div>
              <h2 style="color: #fff; margin: 0 0 16px 0; font-size: 16px; font-weight: 700; font-family: 'Playfair Display', serif;">Tasks</h2>
              <div class="tasks-list" style="background: #1a1a1a; padding: 16px; border-radius: 8px; border-left: 4px solid #f59e0b;">
                ${tasks.length > 0 ? `
          ...
          <!-- Footer -->
          <div class="footer" style="background: linear-gradient(135deg, #f59e0b 0%, #fa8c1d 100%); padding: 24px 28px; text-align: center;">
            <p style="color: #000; margin: 0 0 8px 0; font-size: 14px; font-weight: 600; font-style: italic;">Master your day, Every single day !</p>
            <p style="color: #1a1a1a; margin: 0; font-size: 12px; font-weight: 500;">© Tickd ${new Date().getFullYear()} | All Rights Reserved</p>
          </div>
